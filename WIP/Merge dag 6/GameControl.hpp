...
private:
    ...
    std::map<std::string, picture> objectList = {
        ...
        {"crate", picture(sf::Vector2f( 1000.0, 500.0 ), "images/Crate.jpg", sf::Vector2f( 40.0, 40.0 ))} //set crate out of screen
    };
    ...
    void update(){
        ...
        if(canCollide){
            if(objectList["ship"].collision( objectList["crate"] )){  //Crate test
                ...
                objectList["crate"].move(sf::Vector2f(-100.0,-100.0));
                //toDelete.push_back("crate");
            }
        }
