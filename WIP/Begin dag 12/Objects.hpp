...
public:
	...
	void drawAll(sf::RenderWindow & window){
		...
		draw("Bullet damage: ", stats.bulletDamage, bulletDamage, sf::Vector2f(10.0, 100.0), window);
		draw("Bullet count: ", stats.bulletCount, bulletCount, sf::Vector2f(10.0, 130.0), window);
